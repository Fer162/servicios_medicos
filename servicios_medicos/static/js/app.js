document.addEventListener('DOMContentLoaded', function() {
    ...
    uploadForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            loadingDiv.classList.add('d-none'); // Ocultar mensaje de carga
    ...
    function showResults(data) {
        ...
        if (data.warnings && data.warnings.length > 0) {
            html += `
                <button class="tab-button" onclick="showTab('warnings-tab')">
        ...
        if (data.query_data) {
            ...
            html += `
                        <div class="warning-section">
                            <h5>Archivo Query:</h5>
                            <p>No se pudieron cargar los datos del archivo Query.</p>
                        </div>
            `;
        }
