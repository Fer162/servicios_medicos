...
# Configurar logging ANTES de Flask
...
# ADVERTENCIA: En Render.com, estas carpetas son efímeras (se borran en redeploys). 
# Para persistencia, usa Render Disk o integra S3 (agrega boto3 a requirements.txt y sube archivos a cloud).
...
if __name__ == '__main__':
    # Para desarrollo local. En Render, usa Gunicorn via start command.
    port = int(os.environ.get('PORT', 5000))
    app.run(debug=False, host='0.0.0.0', port=port)  # Removido debug=True para producción
